...
export const Main = (props) => {
  ...
  function deleteTask(e) {
    for (let task of allProjects.projectObj[props.titleRef.current.innerText]
      .taskArray) {
      if (
        task.hash ===
        ...
        const index =
          allProjects.projectObj[
            props.titleRef.current.innerText
    ...
    <div className="main-grid">
      {props.titleRef.current !== null
        ? props.titleRef.current.innerText !== "todo list" &&
          props.titleRef.current.innerText in allProjects.projectObj
          ? Object.values(
              allProjects.projectObj[props.titleRef.current.innerText].taskArray
            ).map((task, index) => (
              <div
                ref={taskRef}
                className="task-card"
              ...
              >
                <div className="task-header">
                  <div className="task-header-left">
                    <img
                      className="trash-task-img"
                      src={deleteTaskImg}
                      onClick={(e) => deleteTask(e, taskRef)}
                      alt="Delete Task"
                    />
                    {task.title}
                  </div>
